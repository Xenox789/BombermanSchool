...
public class NotSoSmartMonster : MonoBehaviour
{
    ...
    private void CalcBestDirection()
    {
        ...
        {
            minDirToPlayer = p1min_dir;
        }
        else if (p1min_dis >= p2min_dis)
        {
            minDirToPlayer = p2min_dir;
        }
    ...
    private void ChangeDirections()
    {
        ...
        if (Random.Range(0,100) <= 30)
        {
            ...
            direction = avDirections[choice];
        } 
        else
        {
            direction = minDirToPlayer;
        }
